...
class purpleAirData():
    ...
    def __pairedReadings(self, json, condition):
        ...
        prefix = condition
        return [json[prefix], json[prefix]]
    ...
    conditions = { 
          'pm2_5_atm'         : conditionInfo(name='PM 2.5',              unit='µg/m³', func=__sensorAvg,   decimalPlaces=1)
        , 'pm10_0_atm'        : conditionInfo(name='PM 10',               unit='µg/m³', func=__sensorAvg,   decimalPlaces=1)
        , 'pm2.5_aqi'         : conditionInfo(name='Air Quality Index',   unit='',      func=__sensorAvg,   decimalPlaces=0)
        ...
        , 'current_temp_f'    : conditionInfo(name='Temperature',         unit='°F',    func=__singleValue, decimalPlaces=1)
        , 'current_humidity'  : conditionInfo(name='Humidity',            unit='%',     func=__singleValue, decimalPlaces=0)
        , 'current_dewpoint_f': conditionInfo(name='Dewpoint',            unit='°F',    func=__singleValue, decimalPlaces=0)
        , 'pressure'          : conditionInfo(name='Barometric Pressure', unit='mbar',  func=__singleValue, decimalPlaces=2)
